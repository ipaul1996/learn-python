...
# Identity: A unique integer guaranteed to be constant for the object's lifetime.
# In CPython (the standard implementation), this is the actual memory address.
# The built-in id() function returns this integer.
...
#    - a is b is equivalent to id(a) == id(b). It checks if a and b refer to the exact same object.
