#  IANA Zones via zoneinfo
from zoneinfo import available_timezones

# Get the full set of zone names
zones = available_timezones()

# how many zones are available?
print(f"{len(zones)} zones available.")  # 598 zones available.

zoneList = sorted(zones)
print(zoneList)
"""
...
'Factory', 'GB', 'GB-Eire', 'GMT', 'GMT+0', 'GMT-0', 'GMT0', 'Greenwich', 'HST', 'Hongkong', 'Iceland', 
