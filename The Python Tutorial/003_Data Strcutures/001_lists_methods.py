...
numbers.insert(
    0, "start"
)  # Insert at the beginning: ['start', 1, 2, 3, 4, 5, 6, 7, 8, '9', '0', 11, 12]
numbers.insert(
    3, "middle"
)  # Insert at index 3: ['start', 1, 2, 'middle', 3, 4, 5, 6, 7, 8, '9', '0', 11, 12]
...
fruits_copy = (
    fruits.copy()
)  # fruits_copy is a new list with the same elements as fruits
...
print(
    fruits
)  # Example output: ['banana', 'apple', 'kiwi', 'banana', 'pear', 'apple', 'orange']
