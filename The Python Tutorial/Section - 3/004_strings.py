...
# Here whitespace and line breaks are preserved.
...
print(
    "Hello " "World!"
)  # "Hello World!" # String concatenation using implicit concatenation
...
print(str[0:5])
# characters from position 0 (included) to 5 (excluded) (size of slice = 5 - 0 = 5)
...
print(str[-6:-1])
# characters from the sixth-last (included) to the second-last (excluded)
...
print(str[:2] + str[2:])
# 'Hello World!' # Concatenation of two slices gives the original string
