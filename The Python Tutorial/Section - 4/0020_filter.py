...
# - The filter() function returns a lazy iterator, so results are computed on demand.
# - Values are only produced when you iterate over the filter object (e.g., with a for loop,
